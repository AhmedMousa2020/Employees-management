    ...
    <x-slot name="header">
        <div class="flex justify-between items-end">
            <div>
                ...
                <span class="text-sm font-light text-gray-400">Update {{ $group->created_at }}</span>
            </div>
            <div>
                <button class="text-red-500 focus:outline-none">Delete group</button>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-end mb-4">
                <h2 class="text-lg font-light">Employees</h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col">
                        @if (count($group->employees) < 1)
                            <h3 class="text-lg w-full text-center">Group have no Employees</h3>
                        @else
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 text-left">
                                                ...
                                                <span class="text-sm font-light text-gray-400">Updated
                                                    {{ \Carbon\Carbon::parse($employee->created_at)->diffForHumans() }}</span>
                                            </td>
